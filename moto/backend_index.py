# autogenerated by C:\git\moto-incidents\scripts\update_backend_index.py
import re
...
backend_url_patterns = [
    ...
    ("ssm-contacts", re.compile("https?://ssm-contacts\\.(.+)\\.amazonaws\\.com")),
    ("ssm-incidents", re.compile("https?://ssm-incidents\\.(.+)\\.amazonaws\\.com")),
